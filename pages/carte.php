    ...
    <div id="toutes" class="pizza">
        ...
        <ul>
            <li>
                ...
                <p>Prix: 8,99€</p>
                <button class="commander" data-produit="Pizza Margherita" data-prix="8.99">Ajouter au panier</button>
            </li>
            <li>
                ...
                <p>Prix: 9,99€</p>
                <button class="commander" data-produit="Pizza Pepperoni" data-prix="9.99">Ajouter au panier</button>
            </li>
            <li>
                ...
                <p>Prix: 10,99€</p>
                <button class="commander" data-produit="Pizza Quatre fromages" data-prix="10.99">Ajouter au panier</button>
            </li>
            <li>
                ...
                <p>Prix: 11,99€</p>
                <button class="commander" data-produit="Pizza Vegetarienne" data-prix="11.99">Ajouter au panier</button>
            </li>
            <li>
                ...
                <p>Prix: 12,99€</p>
                <button class="commander" data-produit="Pizza HaWaienne" data-prix="12.99">Ajouter au panier</button>
</li>
</ul>
</div>
<br>
...
<h2>Nouveautés</h2>
    <ul>
        <li>
            ...
            <p>Prix:14 €</p>
            <button class="commander" data-produit="Beef&Cheddar" data-prix="14">Ajouter au panier</button>
        </li>
        <li>
                ...
                <p>Prix:13 €</p>
                <button class="commander" data-produit="Authentique Raclette" data-prix="13">Ajouter au panier</button>
            </li>
            <li>
                ...
                <p>Prix:12.20 €</p>
                <button class="commander" data-produit="Divine 3 fromages" data-prix="12.90">Ajouter au panier</button>
            </li>
            <li>
                <h4>Savoyarde</h4>
                ...
                <p>Prix:11.99 €</p>
                <button class="commander" data-produit="Savoyarde" data-prix="11.99">Ajouter au panier</button>
            </li>
            <li>
                ...
                <p>Prix:13.99 €</p>
                <button class="commander" data-produit="Chicken & Cheddar" data-prix="13.99">Ajouter au panier</button>
            </li>
    </ul>
</div>
<br>
<div id="vegan" class="pizza">
    ...
    <ul>
        <li>
            ...
            <p>Prix:11.99 €</p>
            <button class="commander" data-produit="Royal Veggie" data-prix="11.99">Ajouter au panier</button>
        </li>
        <li>
                <h4>Cheesy & Veggie</h4>
                ...
                <p>Prix:8.99 €</p>
                <button class="commander" data-produit="Cheesy&Veggie" data-prix="8.99">Ajouter au panier</button>
            </li>
            <li>
                <h4>Peppina</h4>
                ...
                <p>Prix:9.99 €</p>
                <button class="commander" data-produit="Peppina" data-prix="9.99">Ajouter au panier</button>
            </li>
            <li>
                <h4>Super Veggie</h4>
                ...
                <p>Prix:7.99 €</p>
                <button class="commander" data-produit="Super Veggie" data-prix="7.99">Ajouter au panierr</button>
            </li>
</ul>
</div>
<script>
